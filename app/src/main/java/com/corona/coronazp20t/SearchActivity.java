...
public class SearchActivity extends AppCompatActivity {
    public static final String MARGARITA_API = "thecocktaildb.com/api/json/v1/1/search.php?s=margarita";

    private RecyclerView recyclerView;
    private Adapter adapter;

    private ArrayList<MargaritaCocktails> margaritaList = new ArrayList<MargaritaCocktails>();
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            // From all cocktails creates specific list by searched name
            ArrayList<MargaritaCocktails> margaritaListByName = JSON.getMargaritaListByName(margaritaList, query);
    ...
    private class AsyncFetch extends AsyncTask<String, String, ArrayList<MargaritaCocktails>> {
        ...
        @Override
        protected ArrayList<MargaritaCocktails> doInBackground(String... params) {
            try {
                JSONObject jsonObject = JSON.readJsonFromUrl(MARGARITA_API);

                    JSONArray jsonArray = null;
                    margaritaList = new ArrayList<MargaritaCocktails>();
                    try {
        ...
        @Override
        protected void onPostExecute(ArrayList<MargaritaCocktails> margaritaList) {
            //this method will be running on UI thread
            pdLoading.dismiss();
